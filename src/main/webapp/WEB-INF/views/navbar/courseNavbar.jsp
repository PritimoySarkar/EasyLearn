		...
		<div class="ui container grid">
			...
			<div class="computer only row">
				<a href="/allcourses" class="header item easy-learn"
					style="font-size: 2rem">Easy Learn</a> <a href="/allcourses"
					class="item menu-item"><i class="book icon"></i>All Courses</a> <a
					href="/enrolledcourses" class="item menu-item"><i
			...
			<div class="right menu">
				...
				<div class="item menu-item ui simple dropdown"
					...
					<div class="menu">
						<div onclick="window.location.href='/dashboard'" class="item">
							<i class="user icon"></i><a style="color: black">Profile</a>
						</div>
						<div onclick="logOutFunction()" class="item">
							<i class="power off icon"></i><a style="color: black">Log Out</a>
						</div>
					</div>
				</div>
				</div>
